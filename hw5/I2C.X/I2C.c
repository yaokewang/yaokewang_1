...
#define  configRead 0b01000001 
#define  configWrite 0b01000000
#define  IODIR 0x00
#define  GPIO 0x09
#define  OLAT 0x0A
...
int main() {
   ...
   // TRISBbits.TRISB2 = 0;
    ...
    while(1) {
        ...
        i2c_master_start(); 
        setEx(configWrite,IODIR); 
        i2c_master_send(0b11111000); 
        i2c_master_stop();
        
         i2c_master_start(); 
        setEx(configWrite,OLAT);
        i2c_master_send(0b00000000);
        i2c_master_stop(); 
        
        i2c_master_start(); 
        setEx(configWrite,GPIO); 
        i2c_master_restart();
       ...
       if(rdata<0x2)  //    Contains radta=00000000 and rdata=00000001  
        {
        i2c_master_start(); 
        setEx(configWrite,OLAT);
