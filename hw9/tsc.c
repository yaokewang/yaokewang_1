...
int main() {
    ...
    while(1) {
        ...
        spi_io(tcfgzp);
        temp=spi_io(0);
        zp=temp<<4|0b0000111111110000+spi_io(0)>>4;
        spi_io(tcfgzm);
        temp=spi_io(0);
        zm=temp<<4|0b0000111111110000+spi_io(0)>>4;
